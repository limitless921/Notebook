...
//        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        Log.w("zl100","requestCode111==="+requestCode);
        Log.w("zl100","resultCode222==="+resultCode);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        Log.w("zl100","info.id=="+info.id);
        int position= (int) info.id;
        PadApp padApp= (PadApp) mPadAdapter.getItem(position);
        Log.w("zl100","padApp.getId()=="+padApp.getId());


        switch (item.getItemId()){
            case 0:
                Log.w("zl100","onContextItemSelected 0");
                //打开
                Intent intent=new Intent(MainActivity.this,NotePadSeeActivity.class);
                ...
                break;
            case 1:
                Log.w("zl100","onContextItemSelected 1");
                //编辑
                ...
                break;
            case 2:
                Log.w("zl100","onContextItemSelected 2");
                //删除
